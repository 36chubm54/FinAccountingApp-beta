...
- Documented the current security posture explicitly: `AppData` runtime state, plaintext backup/export files, uninstall behavior, and recommended host protections such as `BitLocker`
